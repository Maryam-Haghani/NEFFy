...
| `--first_monomer_length=<value>` | Length of the monomers, which is used to obtain NEFF for paired MSA and individual monomer MSA | when _multimer_MSA_=true | 0 | `--first_monomer_length=17`    |
